...
export type HeadersLike = Headers | readonly HeaderValue[][] | Record<string, HeaderValue | readonly HeaderValue[]> | null;
...
export type SdkTransport = {
    get<ResponseType>(path: string, options?: RequestOptions | Promise<RequestOptions>): APIPromise<ResponseType>;
    post<ResponseType>(path: string, options?: RequestOptions | Promise<RequestOptions>): APIPromise<ResponseType>;
    patch<ResponseType>(path: string, options?: RequestOptions | Promise<RequestOptions>): APIPromise<ResponseType>;
    put<ResponseType>(path: string, options?: RequestOptions | Promise<RequestOptions>): APIPromise<ResponseType>;
    delete<ResponseType>(path: string, options?: RequestOptions | Promise<RequestOptions>): APIPromise<ResponseType>;
};
